...
format:
  html:
    toc: true # Add headers and table of contents
    toc-depth: 2
bibliography: references.bib # Formatted citations
execute:
...
Additionally, note that in @tbl-horse-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-figure1.
