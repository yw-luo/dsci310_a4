...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){#fig-figure1}

<!-- @fig-figure1: Horse populations for all provinces in Canada from 1906 - 1972. -->
...
We present the standard deviations in @tbl-horse1.
...
Additionally, note that in @tbl-horse1 we consider the sample standard deviation of the number of horses during the same time span as @fig-figure1.

![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-figure2 width=70%}

<!-- @fig-figure2: Horse populations for the province with the largest standard deviation -->

In @fig-figure2 we zoom in and look at the province of ???, which had the largest spread of values in terms of standard deviation.
